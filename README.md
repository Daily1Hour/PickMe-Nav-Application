...
![스크린샷](https://github.com/user-attachments/assets/b8587f04-f71c-4740-b361-6c5212d26b89)
...
│  │  ├─ App.svelte
│  │  ├─ main.ts # 개발 서버 진입점
│  │  └─ mfa.ts # single-spa 애플리케이션 빌드 진입점
│  ├─ pages # 페이지
│  │  └─ nav
│  │     ├─ index.ts
│  │     └─ ui
│  │        ├─ AuthControl.svelte # parcel
│  │        └─ NavTopBar.svelte # 네비게이션바
│  └─ shared
